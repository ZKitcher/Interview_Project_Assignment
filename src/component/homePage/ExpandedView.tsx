...
const ExpandedView: React.FC<ExpandedProp> = ({ ExpandedItem, tempFormat, mapLoaded }) => {
    ...
    const lat = ExpandedItem.lat;
    const lon = ExpandedItem.lon;
        ...
        <div className="expanded-view">
            <div className="expanded-content">
                ...
                <div className="weather-info">
                    ...
                    <p>Current Temp: {<DisplayTemp temp={ExpandedItem.temp} format={tempFormat} />}</p>
                    <p>Feels Like: {<DisplayTemp temp={ExpandedItem.feelsLike} format={tempFormat} />}</p>
                    <p>Humidity: {ExpandedItem.humidity}%</p>
                    <p>Wind: {ExpandedItem.wind}m/s. {TranslateDirection(ExpandedItem.windDirection)}
